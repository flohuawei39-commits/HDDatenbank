...
/** Die sechzehn Laute, mit denen ueberall gerechnet wird.

    `io`, `iu` und `ui` werden nicht aus der Schreibweise erkannt: im Deutschen
    sind das fast immer zwei Silben (Na-ti-on, Ru-i-ne, Ra-di-um), und eine
    Regel dafuer wuerde mehr zerreissen als treffen. Sie stehen fuer Anmerkung,
    Korrektur und Suche bereit — fuer Woerter, die man wie im Englischen als
    einen Klang spricht.                                                   */
const LAUTE = ['a', 'e', 'i', 'o', 'u', 'ä', 'ö', 'ü', 'au', 'eu', 'ei', 'ie', 'ey', 'io', 'iu', 'ui'];
