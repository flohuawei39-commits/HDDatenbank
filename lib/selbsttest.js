...
// Ein Eintrag ohne die Marke ist aelter und behaelt seine alte Ausrichtung.
...
pruefe('was ohne Marke dasteht, bleibt am laengsten Stueck ausgerichtet',
  endStand()[3].versatz, endStand()[0].versatz + 2);

reimedaten.eintragSpeichern({ gruppe: endGruppe, id: 'alt1', text: 'Mäuseplage' });
pruefe('einmal geaendert, gilt auch dort die Endregel',
...
const endZeilen = reimedaten.ansicht('zeilen', null).zeilen;
