...
const schluesselHolen = (config) => process.env.HDD_WEB3FORMS_KEY || (config.mail && config.mail.schluessel) || null;
...
module.exports = { bauen, auftrag, quittieren, testAuftrag, schluesselHolen, FRIST_FENSTER, VORSCHAU_TAGE };
