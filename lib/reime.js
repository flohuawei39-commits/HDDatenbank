...
/* Zwoelf Toene, moeglichst weit auseinander auf dem Farbkreis, damit auch
   a und e auf dunklem Grund nicht ineinanderlaufen. Umstellbar in den
   Einstellungen; das hier ist nur der Anfangsstand. */
const FARBEN = {
  a: '#ff6161', au: '#ff9b42', i: '#ffe14d', ü: '#b9e04a',
  u: '#4fd97a', ei: '#2fd7ad', e: '#34e2e2', eu: '#4bb8ff',
  ö: '#7d8dff', o: '#b07dff', ey: '#ff6fe0', ä: '#ff6b9d'
};
